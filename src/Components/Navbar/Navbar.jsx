  ...
  return (
    <nav className="sticky z-[1000] top-0 flex items-center justify-between w-[100%] h-[10vh] bg-[#004080] font-lato px-[2rem]">
      ...
      <ul className="flex items-center h-full">
        <NavLink
          className={({ isActive }) =>
            `${isActive ? "h-full w-[7rem] flex items-center justify-center bg-[#ffffff] text-[#004080] font-bold" : "h-full w-[7rem] text-[#ffffff] flex items-center justify-center font-bold"}`
          }
          to="/"
        >
          <li>Home</li>
