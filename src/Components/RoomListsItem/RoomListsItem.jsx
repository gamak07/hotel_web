...
const RoomListsItem = ({rooms}) => {
    ...
    const { name, image, pricePerNight, maxGuests, availableRooms, bedType, id } = rooms
    ...
    <div className='w-[100%] bg-[#004080]'>
        ...
        <div className='flex flex-col gap-[10px] p-[1.5rem]'>
            ...
            <div className='flex items-center justify-between'>
                <p className='text-[15px] text-[#ffffff]'><span></span>{bedType}</p>
            ...
            <Button onClick={() =>handleDetails(id)}>
                <p className='bg-[#FFD700] text-[#ffffff] text-[20px] font-bold py-[1rem[2rem]'>View Details </p>
            </Button>
        </div>
    </div>
  )
