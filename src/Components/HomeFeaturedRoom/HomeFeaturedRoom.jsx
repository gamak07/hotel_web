...
const HomeFeaturedRoom = () => {
    ...
    return (
        <div className='mx-4 md:mx-8 py-8'>
            <h1 className='text-center font-lato text-3xl md:text-4xl my-4'>Featured Rooms</h1>
            <Swiper
            ...
            >
                {featuredRooms.map(room => (
                    room.isFeatured && (
                        <SwiperSlide key={room.id} className='bg-[#004080] rounded-lg overflow-hidden shadow-lg'>
                            ...
                            <div className='flex flex-col gap-2 p-4'>
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <p className='flex items-center text-2xl font-bold text-[#FFD700]'>
                                        ${room.pricePerNight} 
                                        <span className='text-sm font-normal text-[#ffffff]'> / night</span>
                                    </p>
                                </div>
                                ...
                                <Button onClick={() => handleDetails(room.id)}>
                                    <p className='bg-[#FFD700] text-[#004080] text-lg font-bold py-2 px-4 rounded'>View Details</p>
                                </Button>
                            </div>
                        </SwiperSlide>
                    )
